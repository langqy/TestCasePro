...
class Constant():
    ...
    CON_iStandby = 11
    CON_iSumPitch = 17 
    CON_iSumPitchIntegration = '.CON_iSumPitch'
class Variable():
    #叶片角度    
    InitTraceLoggerDone = ".g_bInitTraceLoggerDone"
    servicepack = '.gsservicepack'
    test = "1"
    pitch = '.grpitchangle'
...
class Parmeter():
    ...
    #YLJ
    PowerMeterType = '.PAR_iReadPowerMeterType'
    MA600_state = 'PRG_ReadModBusPheonexMA600.state'
